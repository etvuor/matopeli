...
module.exports = {
    ...
    async execute(message, args) {
        ...
        //tarkistaa onko jäsenellä oikeukdet, onko hänellä tarvittavat oikeudet ja että komento on kirjoitettu oikeaan muotoon
        ...
        const videoFinder = async (query) => {
            ...
            //jos videoita >1 hakusanoilla valitaan ensimmäinen video
